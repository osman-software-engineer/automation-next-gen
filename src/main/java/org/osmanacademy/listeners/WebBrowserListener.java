...
public class WebBrowserListener implements WebDriverListener {

    private static final Logger logger = LoggerFactory.getLogger(WebBrowserListener.class);
    ...
    public void beforeFindElement(WebDriver driver, By locator) {
        logger.info(STR."Trying to Find Element: \{locator.toString()}");
        WebDriverListener.super.beforeFindElement(driver, locator);
    }

    @Override
    public void afterFindElement(WebDriver driver, By locator, WebElement result) {
        logger.info(STR."Found Element: \{locator.toString()}");
    ...
    public void beforeClick(WebElement element) {
        logger.info(STR."Trying to click on: \{element.toString()}");
        WebDriverListener.super.beforeClick(element);
    }

    @Override
    public void afterClick(WebElement element) {
        logger.info(STR."Clicked on: \{element.toString()}");
    ...
    public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
        logger.info(STR."Trying to type on: \{element.toString()}");
        WebDriverListener.super.beforeSendKeys(element, keysToSend);
    }

    @Override
    public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
        logger.info(STR."Typed on: \{element.toString()}");
