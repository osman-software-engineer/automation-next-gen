...
public class TestDataAutomationImpl implements TestDataGenerator {

    private final Faker faker;

    public TestDataAutomationImpl() {
    ...
    public static void main(String[] args) throws Exception {
        TestDataGenerator testDataGenerator = new TestDataAutomationImpl();
