...
public class WebServicesTestFileLocations {
	...
	public static final String TEST_EXECUTION_PROPERTY_FILE = System.getProperty("user.dir") + File.separator + "src"
			+ File.separator + "main" + File.separator + "resources" + File.separator + "webservices_testexecution.properties";
	...
	private WebServicesTestFileLocations() {
